...
describe('Starting tests for angular-app', function() {
  ...
  it('navbar-brand should be angular-app',() => {
    ...
    it('Crop component should be loadable',() => {
      page.navigateTo('/Crop');
      browser.findElement(by.id('assetName'))
      .then((assetName) => {
        return assetName.getText();
      })
      .then((txt) => {
        expect(txt).toBe('Crop');
      });
    });

    it('Crop table should have 10 columns',() => {
      page.navigateTo('/Crop');
    ...
    it('Farm table should have 4 columns',() => {
      page.navigateTo('/Farm');
      element.all(by.css('.thead-cols th')).then(function(arr) {
    ...
    it('Treatment component should be loadable',() => {
      ...
      .then((txt) => {
        expect(txt).toBe('Treatment');
      });
    });

    it('Treatment table should have 5 columns',() => {
      page.navigateTo('/Treatment');
      element.all(by.css('.thead-cols th')).then(function(arr) {
    ...
    it('Irrigation component should be loadable',() => {
      page.navigateTo('/Irrigation');
      browser.findElement(by.id('assetName'))
      .then((assetName) => {
        return assetName.getText();
      })
      .then((txt) => {
        expect(txt).toBe('Irrigation');
      });
    });

    it('Irrigation table should have 7 columns',() => {
      page.navigateTo('/Irrigation');
      element.all(by.css('.thead-cols th')).then(function(arr) {
    ...
    it('Packet table should have 6 columns',() => {
      page.navigateTo('/Packet');
      element.all(by.css('.thead-cols th')).then(function(arr) {
    ...
    it('AgriChainNetworkAdmin component should be loadable',() => {
      page.navigateTo('/AgriChainNetworkAdmin');
      browser.findElement(by.id('participantName'))
      .then((participantName) => {
        return participantName.getText();
      })
      .then((txt) => {
        expect(txt).toBe('AgriChainNetworkAdmin');
      });
    });

    it('AgriChainNetworkAdmin table should have 5 columns',() => {
      page.navigateTo('/AgriChainNetworkAdmin');
      element.all(by.css('.thead-cols th')).then(function(arr) {
        expect(arr.length).toEqual(5); // Addition of 1 for 'Action' column
      });
    ...
    it('Wholesaler component should be loadable',() => {
      page.navigateTo('/Wholesaler');
      browser.findElement(by.id('participantName'))
      .then((participantName) => {
        return participantName.getText();
      })
      .then((txt) => {
        expect(txt).toBe('Wholesaler');
      });
    });

    it('Wholesaler table should have 5 columns',() => {
      page.navigateTo('/Wholesaler');
      element.all(by.css('.thead-cols th')).then(function(arr) {
        expect(arr.length).toEqual(5); // Addition of 1 for 'Action' column
      });
    ...
    it('transferCrops component should be loadable',() => {
      page.navigateTo('/transferCrops');
      browser.findElement(by.id('transactionName'))
      .then((transactionName) => {
        return transactionName.getText();
      })
      .then((txt) => {
        expect(txt).toBe('transferCrops');
      });
    });
  
    it('notifyParties component should be loadable',() => {
      page.navigateTo('/notifyParties');
      browser.findElement(by.id('transactionName'))
      .then((transactionName) => {
        return transactionName.getText();
      })
      .then((txt) => {
        expect(txt).toBe('notifyParties');
      });
    });
