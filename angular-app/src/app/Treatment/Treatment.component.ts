...
export class TreatmentComponent implements OnInit {
  ...
  constructor(public serviceTreatment: TreatmentService, fb: FormBuilder) {
  ...
  addAsset(form: any): Promise<any> {
    this.asset = {
      $class: 'org.agrichain.crop.Treatment',
      'treatmentID': this.treatmentID.value,
      'treatmentDate': this.treatmentDate.value,
  ...
  updateAsset(form: any): Promise<any> {
    ...
    return this.serviceTreatment.updateAsset(form.get('treatmentID').value, this.asset)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
      this.loadAll();
  ...
  getForm(id: any): Promise<any> {
    ...
    .then((result) => {
      ...
      if (result.treatmentID) {
        formObject.treatmentID = result.treatmentID;
      } else {
        formObject.treatmentID = null;
      }

      if (result.treatmentDate) {
        formObject.treatmentDate = result.treatmentDate;
      } else {
        formObject.treatmentDate = null;
      }
