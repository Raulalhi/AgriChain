...
export class ProductComponent implements OnInit {
  ...
  productmanufacturer = new FormControl('', Validators.required);
  ...
  addAsset(form: any): Promise<any> {
    this.asset = {
      $class: 'org.agrichain.crop.Product',
      'productID': this.productID.value,
      'productName': this.productName.value,
      'productmanufacturer': this.productmanufacturer.value
    };
  ...
  getForm(id: any): Promise<any> {
    ...
    .then((result) => {
      ...
      if (result.productmanufacturer) {
        formObject.productmanufacturer = result.productmanufacturer;
      } else {
        formObject.productmanufacturer = null;
      }
